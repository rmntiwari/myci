...
<div class="container">
    <div class="jumbotron">
        <h2>Test of batch insert | <small>Codeigniter batch insert test</small></h2>
        <p><a class="btn btn-primary btn-lg" href="#">Learn more</a> Author: <a href="#">Proprofs admin</a></p>
    </div>
            ...
            <div class="col-md-12">
                ...
                <fieldset><legend>Journey Details</legend>
                    ...
                    <table style="width: 100%" class="table">
                        <thead><tr><th>Sr.No.</th><th>Date</th><th>Type</th><th>Passenger</th><th>From</th><th>To</th><th>Ticket No.</th><th>Amount</th></tr></thead>
    ...
    $(document).ready(function (){
        $("body").on('click', '.btn-add-more', function (e) {
            ...
            var $html = '<tr class="jdr1" id="' + rowid + '">' +
                '<td><span class="btn btn-sm btn-default">' + $sr + '</span>' +
                '<input type="hidden" name="count[]" value="'+Math.floor((Math.random() * 10000) + 1)+'"></td>' +
        ...
        $("#frm_submit").on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url() ?>batchinsert_controller/batchInsert',
                type: 'POST',
